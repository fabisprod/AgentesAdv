---
name: civel-cumprimento-de-sentenca
description: Gera uma petição de cumprimento de sentença completa para obrigação de
  pagar quantia certa (definitivo ou provisório), seguindo rigorosamente os arts.
  513 a 519 e 523 a 527 do CPC/2015, com memorial de cálculo discriminado conforme
  art. 524, intimação do devedor na forma correta, requerimento de penhora e demais
  medidas executivas, incluindo multa e honorários do art. 523, §1º. Use esta skill
  quando a solicitação envolver Cumprimento de Sentença.
---
