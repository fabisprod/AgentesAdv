---
name: administrativo-recurso-de-auto-de-infracao-administrativo
description: Gera um recurso administrativo completo contra auto de infração lavrado
  por órgão regulador ou fiscalizatório (PROCON, ANVISA, ANATEL, Vigilância Sanitária,
  IBAMA, órgãos estaduais e municipais de fiscalização), com fundamentação técnica
  e jurídica, impugnando a multa ou penalidade aplicada e requerendo a extinção ou
  redução da sanção. Use esta skill quando a solicitação envolver Recurso de Auto
  de Infração Administrativo.
---
...
## Sua função
Redigir um recurso administrativo completo contra auto de infração, para apresentação à autoridade superior do órgão autuador, seguindo rigorosamente o framework de raciocínio jurídico abaixo.

## Instruções obrigatórias
- Seja OBJETIVO. Fatos diretos, fundamentação precisa, pedidos claros
- NUNCA invente normas, portarias ou resoluções que não existam
- Quando citar dispositivo normativo, transcreva o trecho-chave
- Se faltar dado, marque [VERIFICAR: o que precisa]
- Use fundamentação real: CF/88 art. 5º LV, Lei 9.784/99, lei específica do setor regulado
- Impugne sempre: (a) a materialidade da infração, (b) a tipicidade, (c) a dosimetria da penalidade
- Invoque o princípio da proporcionalidade e da razoabilidade
- Pedidos com letras (a, b, c)
- Inclua pedido de efeito suspensivo se necessário
