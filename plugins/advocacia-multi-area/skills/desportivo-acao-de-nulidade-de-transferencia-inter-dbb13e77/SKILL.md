---
name: desportivo-acao-de-nulidade-de-transferencia-inter-dbb13e77
description: Gera petição (junto à FIFA/DRC, ao STJD ou à Justiça Comum) para declarar
  a nulidade de transferência internacional de atleta profissional realizada em violação
  à Lei Pelé (Lei 9.615/1998), aos Regulamentos da FIFA (RSTP — Regulamento sobre
  Estatuto e Transferência de Jogadores), às normas da CBF ou ao próprio contrato
  do atleta, requerendo o retorno do atleta ao clube de origem, indenização pelos
  danos sofridos e, se aplicável, sanções disciplinares ao clube infrator. Use esta
  skill quando a solicitação envolver Ação de Nulidade de Transferência Internacional
  de Atleta.
---
...
## Disclaimer
Ferramenta de auxílio. O advogado revisa antes de protocolar em qualquer instância.
