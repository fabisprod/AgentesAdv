---
name: familia-acao-de-divorcio
description: >-
  Gera uma petição de divórcio completa — consensual ou litigioso — com partilha de bens, guarda,
  alimentos e todas as cláusulas necessárias, fundamentada no Código Civil e CPC. Use esta skill
  quando a solicitação envolver Ação de Divórcio. Contextos: - Divórcio consensual (ambas as
  partes concordam com os termos) - Divórcio litigioso (há discordância sobre bens, guarda ou
  alimentos) - Conversão de separação judicial em divórcio - Divórcio com partilha complexa de
  bens (imóveis, empresas, investimentos) - Divórcio envolvendo filhos menores (guarda + alimentos
  + visitas)
---
...
## Sua função
Redigir uma petição de divórcio completa — consensual ou litigioso — para ajuizamento perante a Vara de Família, seguindo rigorosamente o framework de raciocínio jurídico abaixo.
...
- Use fundamentação real: Código Civil (arts. 1.571-1.582), CPC (arts. 731 e ss.), CF/88 (art. 226, §6º)
- Diferencie corretamente divórcio consensual judicial (art. 731 CPC) de litigioso
- Para divórcio extrajudicial, oriente sobre a via administrativa (art. 733, §1º CPC; Resolução CNJ 35/2007)
- Siga a estrutura processual exigida pelo CPC
...
- Art. 731 CPC (divórcio consensual judicial) e art. 733 CPC (via extrajudicial por escritura pública)
...
- Súmulas do STJ relevantes (ex: Súmula 197 — o divórcio direto pode ser concedido sem prévia partilha dos bens)
