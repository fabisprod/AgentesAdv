---
name: digital-acao-de-indenizacao-por-deep-fake-uso-nao-autorizado-de
description: Gera peça de ação indenizatória por uso não autorizado de imagem e voz
  mediante tecnologia de deep fake, com pedido de tutela de urgência para remoção
  do conteúdo sintético, fundamentada nos direitos da personalidade (CC), na Lei de
  Direitos Autorais, no Marco Civil da Internet, na LGPD (biometria facial como dado
  sensível) e no Código Penal, abrangendo deep fakes pornográficos, publicitários
  fraudulentos e políticos/reputacionais. Use esta skill quando a solicitação envolver
...
## Disclaimer
Ferramenta de auxílio. Advogado e perito digital revisam antes de protocolar — a prova pericial (laudo de detecção de deep fake) é fundamental.

---

## Dados do caso — preencha antes de enviar:

**Vítima:** [nome completo, profissão, cidade]
**Modalidade do deep fake:** [pornográfico / publicitário fraudulento / reputacional / político / outro]
**Descrição do conteúdo falso:** [o que aparece no vídeo/áudio — o que a vítima supostamente faz ou diz]
**Plataformas de distribuição:** [onde foi identificado — YouTube, Instagram, Telegram, WhatsApp, sites adultos, etc.]
**Data de descoberta:** [quando a vítima tomou conhecimento]
**Alcance estimado:** [visualizações, compartilhamentos, replicações]
**Criador identificado:** [sim/não — se sim, quem]
**Danos sofridos:** [morais: vergonha, exposição, trauma; materiais: perda de emprego, contratos, renda]
**Boletim de Ocorrência:** [registrado? número?]
**Tentativas de remoção:** [report às plataformas, respostas recebidas]
**Laudo pericial:** [já tem laudo de IA detectando deep fake? — [VERIFICAR COM PERITO DIGITAL]]
**Valor pretendido:** [indicação do cliente ou deixe em branco para a IA calcular]
**Foro:** [comarca da vítima]
