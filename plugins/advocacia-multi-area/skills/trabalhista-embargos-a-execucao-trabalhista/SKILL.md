---
name: trabalhista-embargos-a-execucao-trabalhista
description: >-
  Gera embargos à execução completos para impugnar o título executivo judicial ou extrajudicial
  trabalhista, questionando a existência, a liquidez, a certeza ou a exigibilidade da dívida, ou
  apontando nulidades no processo de execução. Use esta skill quando a solicitação envolver
  Embargos à Execução Trabalhista. Contextos: - Quando o executado discorda dos valores apurados
  na liquidação - Para alegar nulidade na citação ou na penhora - Quando há pagamento anterior não
  reconhecido ou excesso de execução - Para questionar a validade do título executivo ou a
...
- Prazo dos embargos: 5 dias após a garantia da execução ou penhora (art. 884, caput CLT)
- GARANTIA: os embargos à execução trabalhista EXIGEM garantia do juízo ou penhora prévia (art. 884, caput, CLT) — salvo para entidades filantrópicas e seus diretores (art. 884, §6º CLT); é a impugnação ao cumprimento de sentença do processo civil (art. 525 CPC) que dispensa garantia
...
- Súmula 114 TST (inaplicabilidade da prescrição intercorrente) — ATENÇÃO: após a Lei 13.467/2017, o art. 11-A CLT passou a prever prescrição intercorrente de 2 anos na execução
- Súmula 128 TST (depósito recursal e garantia do juízo)
- Súmula 331 TST (responsabilidade subsidiária — pressupostos e limites)
...
Demonstrar que o embargante não é o devedor ou que sua responsabilidade é subsidiária e os pressupostos não foram preenchidos (Súmula 331 TST).
...
V — DA PRESCRIÇÃO INTERCORRENTE (se aplicável — art. 11-A CLT, incluído pela Lei 13.467/2017: prazo de 2 anos)
[Avaliar com cautela a aplicação intertemporal e o marco inicial (art. 11-A, §1º CLT); a Súmula 114 TST refletia o entendimento anterior à reforma]
...
- [ ] Garantia do juízo ou penhora realizada (pressuposto dos embargos — art. 884, caput CLT)
