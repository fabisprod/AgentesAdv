---
name: saude-recurso-ao-crm-por-infracao-etica-medica
description: Gera peça formal de denúncia/representação ao Conselho Regional de Medicina
  (CRM) por infração ao Código de Ética Médica (Resolução CFM 2.217/2018), com descrição
  objetiva dos fatos, identificação das normas éticas violadas e requerimento de instauração
  de processo ético-profissional contra o médico, como instrumento autônomo ou complementar
  à ação judicial de responsabilidade civil. Use esta skill quando a solicitação envolver
...
## Disclaimer
Ferramenta de auxílio. O advogado revisa antes de protocolar. A representação ao CRM é instrumento ético-disciplinar — para a reparação financeira dos danos, a ação judicial é o caminho adequado. Ambos podem ser usados simultaneamente.
