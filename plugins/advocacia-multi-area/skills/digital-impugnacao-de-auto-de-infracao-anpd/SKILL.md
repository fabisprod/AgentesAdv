---
name: digital-impugnacao-de-auto-de-infracao-anpd
description: Gera peça de defesa administrativa (impugnação) contra auto de infração
  lavrado pela Autoridade Nacional de Proteção de Dados (ANPD), com análise dos elementos
  formais e materiais do auto, arguição de nulidades, contestação da tipificação e
  pedido de arquivamento ou redução da sanção, com base na LGPD e no regulamento sancionatório
  da ANPD. Use esta skill quando a solicitação envolver Impugnação de Auto de Infração
  ANPD.
---
