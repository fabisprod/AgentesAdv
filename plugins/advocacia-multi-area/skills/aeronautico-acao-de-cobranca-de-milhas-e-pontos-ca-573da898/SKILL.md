---
name: aeronautico-acao-de-cobranca-de-milhas-e-pontos-ca-573da898
description: Gera petição inicial para ação de cobrança ou indenizatória por cancelamento
  ou expiração indevida de milhas, pontos ou benefícios em programas de fidelidade
  de companhias aéreas. Abrange situações de expiração sem prévia comunicação adequada,
  cancelamento unilateral do programa, alteração retroativa das regras de expiração,
  recusa de resgate de milhas válidas e encerramento de conta com saldo ativo. Fundamenta-se
  no CDC (Lei 8.078/1990), no Código Civil (arts. 422, 475) e nas normas regulatórias
  de programas de fidelidade. Use esta skill quando a solicitação envolver Ação de
  Cobrança de Milhas e Pontos (Cancelamento/Expiração Indevida).
---
...
- Alteração retroativa das regras de validade: a jurisprudência (STJ e tribunais estaduais) tem reconhecido abusividade na redução retroativa da validade de milhas já acumuladas — pesquise e cite os precedentes atuais aplicáveis ao caso, sem inventar números de julgados
- Se faltar dado, marque [VERIFICAR: o que precisa]
- Calcule o valor das milhas com base no preço de mercado das passagens que seriam resgatadas
- Pedidos com letras (a, b, c)

## Disclaimer
Ferramenta de auxílio. O advogado revisa antes de protocolar. A legislação sobre programas de fidelidade está em constante evolução — verifique sempre a jurisprudência mais recente do TJSP, TJRJ e STJ.
...
- Jurisprudência: precedentes do STJ, TJSP e TJRJ sobre cancelamento e expiração de milhas e sobre a abusividade da redução retroativa de validade — pesquisar e citar julgados reais e atuais, sem inventar números
