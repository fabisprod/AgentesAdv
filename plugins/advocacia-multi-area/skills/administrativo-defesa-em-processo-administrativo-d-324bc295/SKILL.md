---
name: administrativo-defesa-em-processo-administrativo-d-324bc295
description: Gera uma defesa completa em Processo Administrativo Disciplinar (PAD)
  instaurado contra servidor público federal (Lei 8.112/90) ou estadual/municipal
  (legislação específica), com impugnação das irregularidades do processo, análise
  das infrações imputadas, demonstração da ausência de culpabilidade e pedido de arquivamento
  ou redução da penalidade. Use esta skill quando a solicitação envolver Defesa em
...
## Sua função
Redigir uma defesa administrativa completa em Processo Administrativo Disciplinar, para apresentação à comissão disciplinar, seguindo rigorosamente o framework de raciocínio jurídico abaixo.
...
- Use fundamentação real: Lei 8.112/90, CF/88 (art. 5º LV), Lei 9.784/99
- Analise sempre: prescrição, nulidades processuais, tipicidade, proporcionalidade
- Pedidos com letras (a, b, c)
- Se a legislação for estadual ou municipal, indique [VERIFICAR: lei disciplinar aplicável]
...
## Prazos Prescricionais — Art. 142, Lei 8.112/90
...
| Ilícito também penal | Prazo da prescrição penal |
