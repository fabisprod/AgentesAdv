---
name: digital-contrato-dpa-com-operador-de-dados
description: Gera Data Processing Agreement (DPA) — Acordo de Processamento de Dados
  — entre controlador e operador, conforme exigido pelo art. 37 da LGPD, com cláusulas
  de responsabilidade, sub-operadores, segurança, auditorias e notificação de incidentes.
  Use esta skill quando a solicitação envolver Contrato DPA com Operador de Dados.
---
