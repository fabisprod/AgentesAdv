---
name: digital-contrato-de-desenvolvimento-de-software-saas
description: Gera contrato completo de desenvolvimento de software sob demanda ou
  prestação de serviços SaaS (Software as a Service), cobrindo propriedade intelectual,
  SLA, proteção de dados (LGPD), sigilo, responsabilidades, rescisão e resolução de
  conflitos — tanto para o desenvolvedor quanto para o contratante. Use esta skill
  quando a solicitação envolver Contrato de Desenvolvimento de Software (SaaS).
---
