---
name: bancario-renegociacao-extrajudicial-de-divida-bancaria
description: Gera carta de proposta de renegociação extrajudicial de dívida bancária,
  com análise da situação financeira do cliente, proposta de pagamento viável, fundamentação
  legal para desconto e argumentação estratégica para maximizar as concessões do banco
  (desconto de juros, parcelamento, carência). Use esta skill quando a solicitação
  envolver Renegociação Extrajudicial de Dívida Bancária.
---
