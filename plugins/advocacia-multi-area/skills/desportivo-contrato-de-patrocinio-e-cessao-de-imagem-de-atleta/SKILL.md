---
name: desportivo-contrato-de-patrocinio-e-cessao-de-imagem-de-atleta
description: Gera contrato de patrocínio esportivo e cessão de direitos de imagem
  de atleta profissional, com fundamento na Lei 9.615/1998 (Lei Pelé), na Lei 9.610/1998
  (Direitos Autorais — imagem), no Código Civil e no Marco Civil da Internet, regulando
  o uso da imagem, nome, voz e marca pessoal do atleta para fins comerciais, com cláusulas
  de exclusividade, obrigações de divulgação e condições de rescisão. Use esta skill
  quando a solicitação envolver Contrato de Patrocínio e Cessão de Imagem de Atleta.
---
