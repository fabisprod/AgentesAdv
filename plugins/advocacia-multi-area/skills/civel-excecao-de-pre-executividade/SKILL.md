---
name: civel-excecao-de-pre-executividade
description: >-
  Gera petição de exceção de pré-executividade para arguição de matérias de ordem pública
  cognoscíveis de ofício, sem necessidade de garantia do juízo, com base na construção
  jurisprudencial consolidada pelo STJ e doutrina processual. Use esta skill quando a solicitação
  envolver Exceção de Pré-Executividade. Contextos: - Para arguir prescrição, ilegitimidade de
  parte, falta de título executivo ou nulidade absoluta da execução - Quando o executado não tem
  bens para garantir o juízo e precisa se defender sem penhora - Para questionar matérias de ordem
  pública que podem ser conhecidas de ofício pelo juiz - Alternativa mais célere aos embargos
  quando a matéria não exige dilação probatória
metadata:
  routing:
    area: Cível
    procedures: ["execução civil"]
    deliverables: ["exceção de pré-executividade"]
    review_status: curadoria-inicial
---
...
- Art. 485, IV e VI, e §3º, CPC: pressupostos processuais e legitimidade/interesse processual, cognoscíveis de ofício
- Art. 337, §5º, CPC: matérias que o juiz pode conhecer de ofício
- Art. 803, parágrafo único, CPC: nulidade da execução pronunciável de ofício pelo juiz, independentemente de embargos
...
- Arts. 778 e 779 CPC: legitimidade ativa e passiva na execução
...
- Se rejeitada: avaliar interposição de agravo de instrumento (art. 1.015, parágrafo único, CPC — decisão interlocutória proferida em processo de execução)
