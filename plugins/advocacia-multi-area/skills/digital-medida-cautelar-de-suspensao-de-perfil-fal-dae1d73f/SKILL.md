---
name: digital-medida-cautelar-de-suspensao-de-perfil-fal-dae1d73f
description: Gera petição de tutela cautelar antecedente ou incidental para suspensão
  imediata de perfil falso em redes sociais que se passa por outra pessoa (impersonation),
  com pedido de revelação dos dados do criador do perfil, fundamentada no Marco Civil
  da Internet, LGPD, Código Civil e Código de Processo Civil. Use esta skill quando
  a solicitação envolver Medida Cautelar de Suspensão de Perfil Falso (Impersonation).
---
...
## Disclaimer
Ferramenta de auxílio. O advogado revisa antes de protocolar — tutelas de urgência têm prazo e exigem precisão.

---

## Dados do caso — preencha antes de enviar:

**Requerente (vítima):** [nome completo, profissão]
**Perfil legítimo:** [URL ou @ do perfil real do cliente]
**Perfil falso:** [URL ou @ do perfil falso identificado]
**Plataforma:** [Instagram / Facebook / TikTok / LinkedIn / outra]
**Data de descoberta:** [quando o cliente descobriu o perfil falso]
**Conteúdo do perfil falso:** [o que está sendo publicado — golpes, ofensas, vendas fraudulentas, etc.]
**Danos já causados:** [vítimas que caíram em golpe, dano à reputação, perdas financeiras]
**Notificação à plataforma:** [enviou report interno? quando? resposta?]
**Boletim de Ocorrência:** [registrado? número?]
**Foro competente:** [comarca onde será ajuizado]
**Urgência:** [descreva por que cada hora de atraso causa mais dano]
