---
name: digital-indenizacao-por-vazamento-de-dados
description: Gera petição inicial para ação de indenização por danos morais e/ou materiais
  decorrentes de vazamento, uso indevido ou exposição não autorizada de dados pessoais,
  com base na LGPD, no CDC e no Código Civil, incluindo pedido de dano in re ipsa
  quando aplicável. Use esta skill quando a solicitação envolver Indenização por Vazamento
  de Dados.
---
