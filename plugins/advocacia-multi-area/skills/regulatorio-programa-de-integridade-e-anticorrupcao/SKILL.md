---
name: regulatorio-programa-de-integridade-e-anticorrupcao
description: Gera um programa de integridade e anticorrupção completo e personalizado
  para a empresa, conforme os parâmetros do Decreto 8.420/2015 (art. 41-43) e da Lei
  12.846/2013, incluindo política anticorrupção, mapeamento de riscos, código de conduta,
  canal de denúncias, treinamentos, due diligence de terceiros e mecanismos de monitoramento
  — pronto para ser apresentado à empresa ou a autoridades como evidência de comprometimento
  com a conformidade. Use esta skill quando a solicitação envolver Programa de Integridade
  e Anticorrupção.
---

# Programa de Integridade e Anticorrupção
...
## Sua função
Redigir um Programa de Integridade e Anticorrupção completo, conforme os parâmetros obrigatórios do Decreto 8.420/2015 (art. 41-43), seguindo rigorosamente o framework de raciocínio jurídico abaixo.

## Instruções obrigatórias
- NUNCA invente normas, artigos ou jurisprudência que não existam
- Cite artigos reais: Lei 12.846/2013, Decreto 8.420/2015, CF/88, Lei 13.303/2016 (se estatal)
- Se houver referência a norma internacional, marque [VERIFICAR: nome e versão]
- Se faltar informação da empresa, marque [VERIFICAR: descrição do que é necessário]
- Use linguagem clara e acessível para os colaboradores (o programa deve ser lido por não-juristas)
- Estruture com todos os 5 pilares do Decreto 8.420/2015
- O programa deve ser acionável, não apenas declaratório

## Disclaimer
Ferramenta de auxílio. O programa deve ser revisado pelo advogado responsável e adaptado à realidade da empresa antes de implementação e uso formal.
...
- Razão social: [nome]
- CNPJ: [número]
- Setor de atuação: [descrição]
- Porte: [grande (>300 funcionários) | médio (50-300) | pequeno (<50) | microempresa]
- Faturamento anual: [R$ ___]
- Número de funcionários: [___]
- Opera internacionalmente? [sim — países | não]
- É empresa pública, mista ou estatal? [sim | não]

**NATUREZA DO RELACIONAMENTO COM O SETOR PÚBLICO:**
[Descreva:
- A empresa participa de licitações? Frequência e valores aproximados?
- Possui contratos com governo federal, estadual ou municipal?
- Necessita de licenças, autorizações ou aprovações regulatórias?
- Tem representantes ou agentes que interagem com agentes públicos?
- Recebe incentivos fiscais ou subsídios governamentais?]

**SITUAÇÃO ATUAL DO COMPLIANCE:**
[Descreva:
- Há programa de integridade existente? [sim — descreva | não]
- Há Compliance Officer designado? [sim — nome/cargo | não]
- Há canal de denúncias operacional? [sim — como funciona | não]
- Houve investigações internas ou externas anteriores? [sim — descreva | não]
- Há treinamentos de ética/compliance realizados? [sim | não]]

**OBJETIVO PRINCIPAL:**
[Implementação nova | Atualização de programa existente | Resposta a investigação | Preparação para licitação | Due diligence M&A | Certificação ISO 37001 | Outro: ___]

**INFORMAÇÕES ADICIONAIS:**
- Há processo em curso (CGU, MP, TCU, agência reguladora)? [sim/não — descreva]
- Há interesse em acordo de leniência (Lei 12.846/2013, art. 16)? [sim/não]
- Observações: [informações adicionais relevantes]
```

---

## Parâmetros do Decreto 8.420/2015 para Avaliação do Programa

| Parâmetro (art. 42) | Descrição |
|--------------------|-----------|
| I - Comprometimento da alta direção | Políticas aprovadas, responsável designado, tom do topo |
| II - Instância de compliance | Compliance Officer com autonomia, recursos e acesso à diretoria |
| III - Análise periódica de riscos | Mapeamento e revisão de riscos de corrupção |
| IV - Políticas e procedimentos | Código de conduta, políticas específicas por tema de risco |
| V - Canal de denúncias | Anônimo, acessível, com proteção ao denunciante |
| VI - Due diligence de terceiros | Avaliação de parceiros, fornecedores, representantes |
| VII - Controles de RH | Treinamento, avaliação e procedimentos disciplinares |
| VIII - Controles contábeis | Registros que impeçam ocultação de pagamentos ilícitos |
| IX - Transparência em licitações | Procedimentos para interações em processos licitatórios |
| X - Monitoramento | Verificação contínua da efetividade e melhoria do programa |
| XI - Medidas corretivas | Procedimentos para resposta a desvios identificados |
