---
name: consumidor-acordo-em-acao-consumerista
description: Redige um termo de acordo judicial ou extrajudicial completo em ação
  consumerista, com composição detalhada de danos materiais e morais, obrigações de
  fazer/não fazer, forma de pagamento, cláusula penal e quitação. Funciona tanto para
  acordo em audiência de conciliação quanto para acordo extrajudicial homologável.
  Use esta skill quando a solicitação envolver Acordo em Ação Consumerista.
---
...
## Sua função
Redigir um termo de acordo consumerista completo, que resolva definitivamente o conflito, proteja ambas as partes e atenda aos requisitos legais para homologação judicial.
...
- Discrimine CADA parcela do acordo (dano material, dano moral, obrigação de fazer)
- Especifique forma e prazo de pagamento com clareza
- Inclua cláusula penal por descumprimento
- Defina o alcance da quitação (total ou parcial, quais verbas)
- NUNCA invente jurisprudência, nº de processo ou súmula
- Se faltar dado, marque [VERIFICAR]
- O acordo deve ser equilibrado — não pode configurar renúncia abusiva de direitos do consumidor (art. 51, I, CDC)
