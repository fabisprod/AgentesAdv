---
name: societario-m-a-fusao-e-aquisicao
description: Gera estrutura completa para operação de M&A (fusão, aquisição de quotas/ações
  ou aquisição de ativos), incluindo análise da estrutura mais adequada, escopo da
  due diligence, minutas das cláusulas principais do SPA (Sale and Purchase Agreement),
  mecanismos de preço (earn-out, escrow, ajuste de preço), declarações e garantias
  (R&W), e condições precedentes. Use esta skill quando a solicitação envolver M&A
  — Fusão e Aquisição.
---
