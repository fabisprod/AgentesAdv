---
name: saude-acao-de-reembolso-de-despesas-medicas
description: Gera petição inicial de ação de cobrança/indenização contra plano de
  saúde para reembolso de despesas médicas pagas pelo beneficiário do próprio bolso,
  seja por atendimento fora da rede credenciada em situação de urgência/emergência,
  por ausência de prestador na localidade ou por negativa indevida de cobertura. Fundamenta-se
  na Lei 9.656/1998, no CDC, no CC/2002 e nas Resoluções da ANS. Use esta skill quando
  a solicitação envolver Ação de Reembolso de Despesas Médicas.
---
...
- Cite artigos reais: Lei 9.656/1998 arts. 12, VI (reembolso em urgência/emergência), 35-C (urgência/emergência); CDC arts. 6º, I, III, VI, 47, 51; CC/2002 arts. 421, 422
- Súmula 608/STJ: CDC aplica-se aos contratos de plano de saúde, salvo os administrados por entidades de autogestão
- Reembolso em urgência: Lei 9.656/1998, art. 35-C c/c art. 12, VI — reembolso quando não for possível a utilização de rede própria ou credenciada; a limitação temporal de internação é abusiva (Súmula 302/STJ)
...
## Disclaimer
Ferramenta de auxílio. O advogado confere todos os comprovantes de pagamento e calcula os valores exatos antes de protocolar.
...
- Qual o prazo prescricional? [VERIFICAR: jurisprudência do STJ sobre o prazo aplicável à pretensão de reembolso contra a operadora]
- Qual o foro competente? (domicílio do consumidor — art. 101, I, CDC)

### ETAPA 2 — ANÁLISE JURÍDICA (Fundamentação)
Apresente dentro de um bloco <fundamentos_juridicos>:
- Lei 9.656/1998: arts. 12 (coberturas obrigatórias), 12, VI (reembolso), 35-C (urgência/emergência), 16 (informações contratuais)
