---
name: previdenciario-embargos-de-declaracao-em-materia-previdenciaria
description: Gera os embargos de declaração em ações previdenciárias para sanar omissão,
  contradição, obscuridade ou erro material na sentença ou acórdão, com fundamento
  nos arts. 1.022 a 1.026 do CPC, apontando com precisão o vício e o que deveria constar
  na decisão. Use esta skill quando a solicitação envolver Embargos de Declaração
