---
name: bancario-acao-de-indenizacao-por-abertura-indevida-1df86da5
description: Gera petição inicial de ação de indenização por danos morais e materiais
  contra instituição financeira que abriu conta bancária em nome do consumidor sem
  seu conhecimento ou consentimento, com pedido de encerramento imediato da conta,
  exclusão de débitos gerados em seu nome e reparação pelos prejuízos causados, fundamentada
  na responsabilidade objetiva do banco e na LGPD. Use esta skill quando a solicitação
  envolver Ação de Indenização por Abertura Indevida de Conta (Conta Fantasma).
---
...
- Resolução CMN 4.753/2019: regras para abertura de conta, inclusive por meio eletrônico — a instituição deve adotar procedimentos que assegurem a identificação e a qualificação do titular
- Súmula 297 STJ: CDC aplica-se às instituições financeiras
- Súmula 359 STJ: "Cabe ao órgão mantenedor do cadastro de proteção ao crédito a notificação do devedor antes de proceder à inscrição" — negativação sem notificação prévia é irregular
...
## Disclaimer
Ferramenta de auxílio. O advogado revisa antes de protocolar. Registrar BO é urgente e deve ser feito antes de ajuizar.
...
- Resolução CMN 4.753/2019: procedimentos obrigatórios para abertura de conta — identificação e qualificação do titular
- Súmula 297 STJ: CDC aplica-se às instituições financeiras
- Súmula 359 STJ: cabe ao órgão mantenedor do cadastro de proteção ao crédito a notificação prévia do devedor antes da inscrição (se houver negativação sem notificação)
...
- Se houver negativação: cumule com pedido de exclusão dos registros decorrentes da dívida inexistente (SCR/Serasa/SPC)
...
4. **Do direito**:
   ...
   - Falha no KYC regulatório (Res. CMN 4.753/2019)
...
- [ ] Violação da Res. CMN 4.753/2019 (KYC) mencionada?
