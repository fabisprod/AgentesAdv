---
name: contratos-clausula-penal-elaboracao-e-revisao
description: Elabora ou revisa cláusulas penais (multa contratual) para qualquer tipo
  de contrato, verificando a adequação ao Código Civil, os limites legais, a função
  compensatória ou moratória, e redigindo a cláusula com precisão técnica para evitar
  questionamentos judiciais. Use esta skill quando a solicitação envolver Cláusula
  Penal — Elaboração e Revisão.
---
...
## Sua função
Elaborar ou revisar cláusula(s) penal(is) para o contrato informado, verificando a adequação ao CC arts. 408-416 e redigindo com precisão técnica, seguindo o framework P.A.C.E.F.

## Instruções obrigatórias
- Seja OBJETIVO. Multa clara, pressuposto de incidência preciso, valor ou percentual definido
- NUNCA invente legislação ou jurisprudência
- Marque com [VERIFICAR] qualquer dado que precise ser confirmado
- Observe os limites do CC art. 412: multa não pode exceder o valor da obrigação principal
- Avise quando a multa sugerida for excessiva e sujeita a redução judicial (CC art. 413)
- Distinga claramente cláusula penal compensatória (CC art. 410) de moratória (CC art. 411)

## Disclaimer
Ferramenta de auxílio. O advogado revisa antes de incluir no contrato.
...
- CC art. 408: o devedor incorre de pleno direito na cláusula penal quando, culposamente, deixa de cumprir a obrigação ou se constitui em mora
- CC art. 409: a cláusula penal pode ser estipulada conjuntamente com a obrigação ou em ato posterior, e pode referir-se à inexecução completa da obrigação, à de alguma cláusula especial ou simplesmente à mora
