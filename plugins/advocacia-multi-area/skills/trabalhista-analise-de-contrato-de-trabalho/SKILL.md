---
name: trabalhista-analise-de-contrato-de-trabalho
description: >-
  Analisa um contrato de trabalho completo, identificando cláusulas abusivas, irregularidades
  legais, riscos para empregado ou empregador, e pontos que precisam de atenção ou correção. Gera
  um relatório estruturado com classificação de risco por cláusula. Use esta skill quando a
  solicitação envolver Análise de Contrato de Trabalho. Contextos: - Antes de assinar um contrato
  de trabalho (lado empregado ou empregador) - Para auditar contratos existentes de clientes
  empresariais - Para identificar riscos trabalhistas em contratos com vícios - Para sugerir
  melhorias em modelos de contrato do escritório - Na análise prévia de contratos em due diligence
  trabalhista
---
