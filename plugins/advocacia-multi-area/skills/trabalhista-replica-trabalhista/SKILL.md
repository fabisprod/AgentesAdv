---
name: trabalhista-replica-trabalhista
description: >-
  Redige a réplica (impugnação à contestação) trabalhista, refutando ponto a ponto as alegações e
  preliminares do reclamado, reforçando a tese do reclamante com contra-argumentação fundamentada
  e impugnando documentos juntados pela defesa. Use esta skill quando a solicitação envolver
  Réplica Trabalhista. Contextos: - Após receber a contestação do reclamado - Para rebater
  preliminares arguidas (prescrição, inépcia, etc.) - Para impugnar documentos apresentados pela
  defesa - Para reforçar pedidos atacados pela contestação - Para apresentar fatos novos trazidos
  pela defesa que precisam de resposta
---
...
**Petição inicial (contexto):**
[Cole a petição inicial ou seus principais pedidos e argumentos]

**Contestação (para impugnar):**
[Cole a contestação completa do reclamado]

**O que é verdade e o que é mentira na contestação:**
[Para cada alegação importante do reclamado, informe:
- Alegação X: verdade / parcialmente verdade / mentira
- Motivo: ...]

**Documentos juntados pelo reclamado para impugnar:**
[Liste e comente:
- Cartões de ponto: são verdadeiros? Refletem a realidade?
- Recibos: foram assinados? São corretos?
- Outros: ...]

**Data da audiência de instrução:** [se agendada]
