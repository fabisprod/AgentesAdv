---
name: previdenciario-ctc-certidao-de-tempo-de-contribuicao
description: Gera o requerimento administrativo e, se necessário, a petição judicial
  para obtenção da Certidão de Tempo de Contribuição (CTC) junto ao INSS ou a Regime
  Próprio de Previdência Social (RPPS), documento indispensável para a contagem recíproca
  do tempo de contribuição entre regimes previdenciários (RGPS e RPPS). Use esta skill
  quando a solicitação envolver CTC — Certidão de Tempo de Contribuição.
---
