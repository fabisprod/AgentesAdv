---
name: eleitoral-prestacao-de-contas-de-campanha-eleitoral
description: Gera orientação estruturada e minuta para a prestação de contas de campanha
  eleitoral perante a Justiça Eleitoral, com base na Lei 9.504/1997 e na resolução
  do TSE vigente para o pleito, incluindo checklist documental, regras de escrituração
  e alertas sobre irregularidades que geram rejeição de contas. Use esta skill quando
  a solicitação envolver Prestação de Contas de Campanha Eleitoral.
---
...
## Disclaimer
Ferramenta de auxílio. O advogado eleitoralista e o contador revisam antes de enviar. Consulte a resolução TSE vigente para o pleito.
...
## DADOS DA CAMPANHA (preencha todos os campos):

**CANDIDATO:**
- Nome: [nome]
- Cargo: [Prefeito / Vereador / Deputado / etc.]
- Partido: [sigla]
- Número na urna: [número]
- O candidato foi eleito? [sim/não]

**A CAMPANHA:**
- Município/Estado: [local]
- Ano da eleição: [ano]
- Teto de gastos fixado para o cargo: [R$ — VERIFICAR resolução TSE]
- Total de despesas declaradas: [R$]
- Total de receitas declaradas: [R$]

**FONTES DE RECEITA:**
- Recursos próprios: [R$]
- Doações de pessoas físicas: [R$ total / quantas doações]
- FEFC: [R$ — se recebeu]
- Fundo Partidário: [R$ — se recebeu]

**PROBLEMAS IDENTIFICADOS:**
- Há despesas sem comprovação? [sim/não — valor estimado]
- Há inconsistências entre receita e despesa? [sim/não — descreva]
- A campanha ultrapassou o teto? [sim/não — em quanto]
- Há doações suspeitas ou vedadas? [sim/não — descreva]

**INFORMAÇÕES ADICIONAIS:**
- Prazo de prestação de contas: [dd/mm/aaaa]
