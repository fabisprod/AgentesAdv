---
name: desportivo-recurso-em-processo-antidoping
description: Gera recurso e defesa em processo antidoping instaurado perante tribunal
  desportivo ou autoridade antidoping nacional, com fundamento no Código Mundial Antidoping
  (WADA), nas Regras Antidoping da confederação específica e no Código Brasileiro
  de Justiça Desportiva (CBJD), contestando a violação imputada, apresentando excludentes
  (ausência de culpa, uso terapêutico, contaminação), e requerendo redução ou afastamento
  da suspensão. Use esta skill quando a solicitação envolver Recurso em Processo Antidoping.
---
...
## Disclaimer
Ferramenta de auxílio. O advogado e médico do esporte revisam antes de protocolar.
