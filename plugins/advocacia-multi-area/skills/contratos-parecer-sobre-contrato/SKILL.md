---
name: contratos-parecer-sobre-contrato
description: Elabora pareceres juridicos completos sobre contratos, analisando viabilidade,
  riscos, clausulas abusivas, omissoes e conformidade legal, com fundamentacao nos
  arts. 104 e 166-167 (validade dos negocios juridicos), arts. 421-480 (contratos
  em geral), CDC, LGPD e legislacao setorial aplicavel. Aplica o framework P.A.C.E.F
  de raciocinio juridico estruturado em 5 etapas. Use esta skill quando a solicitação
  envolver Parecer sobre Contrato.
---
