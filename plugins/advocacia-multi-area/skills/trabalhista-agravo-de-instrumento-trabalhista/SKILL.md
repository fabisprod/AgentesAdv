---
name: trabalhista-agravo-de-instrumento-trabalhista
description: >-
  Gera agravo de instrumento completo para destrancar recurso de revista ou recurso ordinário não
  admitido pelo juízo a quo, com demonstração da admissibilidade do recurso denegado e formação do
  instrumento. Use esta skill quando a solicitação envolver Agravo de Instrumento Trabalhista.
  Contextos: - Quando o recurso de revista for denegado pelo TRT (juízo de admissibilidade
  negativo) - Quando o recurso ordinário for denegado pela Vara do Trabalho - Para demonstrar que
  o recurso principal preenche os requisitos de admissibilidade - Quando houver negativa de
  seguimento por deserção, intempestividade ou ausência de pressupostos formais indevida
---
...
- Art. 897, §5º, I, CLT (peças obrigatórias do instrumento)
- Art. 830 CLT (autenticação de peças — declaração de autenticidade pelo advogado)
- Súmula 421 TST (agravo interno — distinção)
- OJs da SDI-1 sobre formação do instrumento, se aplicáveis
...
Listar as peças que compõem o instrumento (art. 897, §5º, I, CLT):
...
- [ ] Peças obrigatórias do instrumento listadas (art. 897, §5º, I, CLT)
