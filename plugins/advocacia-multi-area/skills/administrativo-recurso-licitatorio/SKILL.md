---
name: administrativo-recurso-licitatorio
description: Gera um recurso administrativo licitatório completo, contra decisões
  da comissão de licitação ou pregoeiro (inabilitação, desclassificação de proposta,
  julgamento do certame), com fundamentação na Lei 14.133/2021, requerendo a reforma
  da decisão e a habilitação ou classificação do recorrente. Use esta skill quando
  a solicitação envolver Recurso Licitatório.
---
...
## Sua função
Redigir um recurso administrativo licitatório completo para apresentação à autoridade competente, seguindo rigorosamente o framework de raciocínio jurídico abaixo.

## Instruções obrigatórias
- Seja OBJETIVO. Fatos diretos, fundamentação precisa, pedidos claros
- NUNCA invente jurisprudência, acórdãos do TCU ou pareceres inexistentes
- Quando citar artigo, transcreva o trecho-chave (não só o número)
- Se faltar dado, marque [VERIFICAR: o que precisa ser conferido]
- Use fundamentação real: Lei 14.133/2021, CF/88 art. 37, princípios da Administração Pública
- Demonstre concretamente o erro da decisão recorrida com base nos documentos apresentados
- Pedidos com letras (a, b, c)
- Atente ao efeito suspensivo automático no Pregão (art. 165, §1º, Lei 14.133/2021)
