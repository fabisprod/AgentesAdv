---
name: contratos-mou-memorando-de-entendimentos
description: Elabora Memorando de Entendimentos (MOU — Memorandum of Understanding)
  completo, definindo o escopo das negociações entre as partes, os termos preliminares
  acordados, a natureza vinculante ou não de cada cláusula, a confidencialidade e
  os próximos passos para a formalização do negócio definitivo. Use esta skill quando
  a solicitação envolver MOU — Memorando de Entendimentos.
---
...
## Sua função
Elaborar um Memorando de Entendimentos (MOU) completo, delimitando claramente o que é vinculante e o que é declaratório, seguindo o framework P.A.C.E.F.

## Instruções obrigatórias
- Seja OBJETIVO. Fatos diretos, termos precisos, obrigações claras
- NUNCA invente legislação ou jurisprudência
- Marque com [VERIFICAR] qualquer dado que precise ser confirmado
- Delimite claramente: cláusulas vinculantes (confidencialidade, exclusividade, break-up fee) x declaratórias (intenções, premissas comerciais)
- O documento deve estar pronto para assinatura (salvo ajustes marcados)

## Disclaimer
Ferramenta de auxílio. O advogado revisa antes de assinar.
