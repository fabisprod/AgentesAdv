---
name: civel-contestacao-civel
description: >-
  Gera uma contestação cível completa para a defesa do réu, com preliminares processuais (art. 337
  do CPC), impugnação específica de cada fato e pedido do autor, fundamentação jurídica sólida e
  pedidos de improcedência total ou parcial. Use esta skill quando a solicitação envolver
  Contestação Cível. Contextos: - Ao defender réu em ação cível (cobrança, indenização, obrigação
  de fazer) - Para montar defesa estruturada impugnando cada pedido do autor - Para identificar
  todas as preliminares e prejudiciais de mérito arguíveis - Para padronizar contestações do
  escritório - Para garantir que nenhum ponto da inicial ficou sem impugnação (art. 341, CPC)
---
