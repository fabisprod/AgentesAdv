---
name: civel-peticao-inicial-civel
description: Gera uma petição inicial cível completa e fundamentada para ações de
  cobrança, indenização por danos materiais e morais, obrigação de fazer/não fazer
  e demais procedimentos comuns, seguindo rigorosamente os requisitos dos arts. 319
  a 321 do CPC/2015, com qualificação das partes, causa de pedir, pedidos certos e
  determinados, valor da causa e requerimentos finais. Use esta skill quando a solicitação
  envolver Petição Inicial Cível.
---
