---
name: trabalhista-agravo-de-peticao-trabalhista
description: >-
  Gera agravo de petição completo para impugnar decisões proferidas na fase de execução
  trabalhista, com fundamentação técnica sobre os limites da impugnação e delimitação precisa das
  matérias recorridas. Use esta skill quando a solicitação envolver Agravo de Petição Trabalhista.
  Contextos: - Para recorrer de decisão proferida na execução (penhora, avaliação, cálculos,
  expropriação) - Quando o juiz rejeitar embargos à execução ou impugnação à liquidação - Para
  questionar a nomeação de bens, arrematação ou adjudicação - Quando houver excesso de execução,
  nulidade ou error in procedendo na fase executiva
---
...
- Prazo: 8 dias (art. 897, caput, CLT)
...
- Súmula 416 TST (prosseguimento da execução quanto às matérias e valores não delimitados no agravo — art. 897, §1º CLT)
- OJs SDI-2 aplicáveis à fase de execução
- Art. 769 CLT c/c art. 803 CPC (nulidade da execução)

### ETAPA 3 — CONSTRUÇÃO
Defina em <estrategia>:
- Tese principal de impugnação (excesso? nulidade? avaliação?)
- Matérias e valores delimitados com precisão
- Se há pedido de efeito suspensivo (art. 995, parágrafo único, CPC c/c art. 769 CLT)
...
"Requer-se a atribuição de efeito suspensivo ao presente recurso, uma vez que [fumus boni iuris + periculum in mora], evitando a expropriação de bem até julgamento definitivo (art. 995, parágrafo único, CPC c/c art. 769 CLT)."
