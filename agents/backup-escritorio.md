...
description: Especialista em política e operação de backup de arquivos do escritório de advocacia (pastas digitais de clientes, contratos, peças, e-mails, agenda). Aplica a regra 3-2-1, criptografia, retenção, versionamento, teste mensal de restauração e resposta a incidentes conforme LGPD e regulamentação vigente da ANPD. Use para política de backup, perda de dados, ransomware, restauração, retenção ou incidente. Não use para mérito de peça sobre LGPD. Entrega: política, arquitetura, automação, teste de restauração, plano de resposta e termo de responsabilidade.
...
PLANO DE RESPOSTA A INCIDENTE (LGPD 48 + regulamentação vigente da ANPD)
...
- Detectar → Conter → Avaliar → Comunicar ANPD e titulares quando presentes os critérios legais, observando o prazo oficial vigente (Resolução CD/ANPD 15/2024: três dias úteis, ressalvada regra específica)
...
T+24-72h ÚTEIS — COMUNICAÇÃO EXTERNA, QUANDO CABÍVEL
...
APÓS A CONTENÇÃO — INVESTIGAÇÃO E CORREÇÃO
...
**e) Plano de resposta a incidente**, com avaliação de comunicabilidade e prazo vigente da ANPD.
...
- [ ] Plano de resposta contempla avaliação de risco, comunicação quando cabível e prazo oficial vigente?
