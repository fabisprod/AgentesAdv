---
name: digital-resposta-a-titular-de-dados
description: Gera resposta formal e juridicamente adequada a requisições de titulares
  de dados pessoais, exercendo os direitos previstos nos arts. 17 a 22 da LGPD (acesso,
  correção, portabilidade, eliminação, revogação de consentimento, etc.), dentro do
  prazo de 15 dias estabelecido pela ANPD. Use esta skill quando a solicitação envolver
