---
name: digital-acao-contra-plataforma-por-remocao-indevida-de-conteudo
description: Gera peça de ação judicial (com pedido de tutela de urgência) contra
  plataforma digital que removeu, suspendeu ou baniu conta ou conteúdo de forma indevida,
  arbitrária ou sem observância de due process, com base no Marco Civil da Internet,
  no CDC e em princípios constitucionais de liberdade de expressão e contraditório.
  Use esta skill quando a solicitação envolver Ação contra Plataforma por Remoção
...
## Disclaimer
Ferramenta de auxílio. O advogado analisa os Termos de Serviço da plataforma e a jurisprudência local antes de protocolar.

---

## Dados do caso — preencha antes de enviar:

**Autor:** [nome/CNPJ, profissão ou atividade empresarial]
**Plataforma ré:** [Meta/Instagram/Facebook / Google/YouTube / TikTok / Mercado Livre / outra]
**Tipo de conta:** [pessoal / profissional / comercial / canal de criador de conteúdo]
**O que foi removido/suspenso:** [post específico / conta inteira / produto/anúncio / monetização]
**Data da remoção:** [data exata ou período]
**Motivo alegado pela plataforma:** [texto da notificação, se houver — ou "sem justificativa"]
**Conteúdo removido:** [descrição objetiva do conteúdo — por que era legítimo?]
**Violação dos ToS alegada:** [a plataforma citou alguma regra específica? qual?]
**Contestação administrativa:** [o autor tentou recuperar via suporte/recurso? qual foi a resposta?]
**Danos sofridos:** [econômicos: perda de receita, vendas, contratos; morais: exposição, reputação]
**Quantificação do dano:** [valores mensais de receita da conta, número de seguidores/clientes perdidos]
**Provas disponíveis:** [prints, histórico de faturamento, extrato de monetização, e-mails da plataforma]
**Foro:** [comarca — considere que plataformas têm foro de eleição muitas vezes em SP ou RJ]
