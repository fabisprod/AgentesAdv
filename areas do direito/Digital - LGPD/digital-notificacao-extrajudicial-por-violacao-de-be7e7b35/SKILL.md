---
name: digital-notificacao-extrajudicial-por-violacao-de-be7e7b35
description: Gera notificação extrajudicial formal por violação de direitos autorais
  na internet (uso não autorizado de obra protegida em site, redes sociais, plataformas
  de streaming, e-commerce, blogs ou aplicativos), com base na Lei de Direitos Autorais,
  com pedido de cessação imediata do uso, remoção do conteúdo, prestação de contas
  e indenização, funcionando também como requisito pré-processual para DMCA Takedown
  e para demonstrar boa-fé antes de uma ação judicial. Use esta skill quando a solicitação
  envolver Notificação Extrajudicial por Violação de Direitos Autorais Online.
---
...
## Disclaimer
Ferramenta de auxílio. O advogado verifica a titularidade da obra e a extensão da violação antes de enviar.

---

## Dados do caso — preencha antes de enviar:

**Notificante (titular dos direitos):** [nome/CNPJ, qualificação completa]
**Tipo de obra:** [fotografia / texto / música / software / design / vídeo / curso online / ilustração / outro]
**Descrição da obra:** [título ou descrição objetiva da obra original]
**Data/local de criação:** [quando foi criada — comprova a anterioridade]
**Registro autoral:** [sim/não — se sim, número e órgão registrador (Biblioteca Nacional, INPI, etc.)]
**Notificado:** [nome/CNPJ do infrator, endereço, e-mail]
**Plataforma da violação:** [site, Instagram, YouTube, Spotify, Shopee, Amazon, blog, aplicativo]
**URL do conteúdo violador:** [link direto do conteúdo infrator]
**Descrição da violação:** [como a obra foi usada sem autorização — reprodução integral, adaptação, distribuição comercial, omissão de crédito]
**Data de descoberta da violação:** [quando o cliente encontrou o uso indevido]
**Dano estimado:** [perda de receita, uso comercial sem licença, valor que seria cobrado pela licença]
**Prazo para resposta:** [5, 7 ou 10 dias úteis]
**Pretensão:** [apenas remoção / remoção + indenização / licenciamento retroativo / outra]
**Plataforma internacional?** [sim/não — se sim, incluir DMCA Takedown em inglês]
