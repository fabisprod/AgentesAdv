---
name: digital-defesa-administrativa-anpd
description: Gera defesa administrativa completa em processo sancionador da ANPD (Autoridade
  Nacional de Proteção de Dados), com argumentação técnico-jurídica para afastar ou
  reduzir sanções previstas no art. 52 da LGPD, incluindo advertência, multa e publicização
  da infração. Use esta skill quando a solicitação envolver Defesa Administrativa
  ANPD.
---
