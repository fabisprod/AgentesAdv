---
name: digital-contrato-de-influenciador-digital-publicidade
description: Gera contrato de prestação de serviços entre marca/anunciante e influenciador
  digital, cobrindo entregas de conteúdo, uso de imagem, direitos autorais sobre posts,
  exclusividade por segmento, obrigações de disclosure (publicidade identificada),
  CONAR, remuneração, rescisão e proteção de dados — tanto para o influenciador quanto
  para a marca. Use esta skill quando a solicitação envolver Contrato de Influenciador
  Digital (Publicidade).
---
...
## Disclaimer
Ferramenta de auxílio. Advogado revisa antes de assinar — especialmente uso de imagem e direitos autorais.

---

## Dados do contrato — preencha antes de enviar:

**Perspectiva:** [ótica da marca / ótica do influenciador — ajusta o equilíbrio das cláusulas]
**Marca/Anunciante:** [nome/CNPJ, segmento de mercado]
**Influenciador:** [nome artístico e nome civil, CPF/CNPJ, plataformas e número de seguidores]
**Objeto da campanha:** [produto/serviço a divulgar]
**Entregas:** [quantidade de posts, reels, stories, lives, menções — com especificações técnicas]
**Prazo da campanha:** [data de início e fim, cronograma de publicações]
**Remuneração:** [valor total, forma de pagamento, gatilhos — antecipado, por entrega, por performance]
**Exclusividade:** [sim/não — se sim, por qual segmento e por qual período]
**Uso da imagem pela marca:** [apenas nas redes do influenciador / redes da marca / mídia paga / TV / site]
**Prazo de uso da imagem após término:** [ex: 6 meses após término do contrato]
**Direitos sobre o conteúdo criado:** [licença de uso / cessão total / cessão parcial]
**Aprovação de conteúdo:** [marca aprova antes de publicar? prazo de aprovação?]
**Cláusula moral:** [sim/não — condições de rescisão por conduta inadequada]
