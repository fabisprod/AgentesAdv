---
name: agrario-defesa-em-desapropriacao-rural
description: Gera contestação e peças de defesa em ação de desapropriação rural para
  fins de reforma agrária, com fundamento na Lei Complementar 76/1993, no Decreto-Lei
  3.365/1941 e na CF/88, contestando vícios do decreto expropriatório, impugnando
  o laudo de avaliação do expropriante e requerendo justa indenização, incluindo honorários
  advocatícios de sucumbência. Use esta skill quando a solicitação envolver Defesa
  em Desapropriação Rural.
---
...
- Cite artigos reais: CF/88 (art. 184-186 — desapropriação para reforma agrária e função social), LC 76/1993 (rito da desapropriação para reforma agrária), DL 3.365/1941 (desapropriação por utilidade pública — aplicado subsidiariamente), Lei 8.629/1993 (função social da propriedade rural — GUT e GEE), instrução normativa vigente do INCRA sobre vistoria e avaliação [VERIFICAR norma atual]
- Se faltar dado, marque [VERIFICAR: o que precisa]
- Pedidos com letras (a, b, c)

## Disclaimer
Ferramenta de auxílio. O advogado e engenheiro agrônomo revisam antes de protocolar.
...
- Instrução normativa vigente do INCRA sobre vistoria e avaliação de imóveis rurais (método de avaliação — terra nua e benfeitorias) [VERIFICAR norma atual]
...
- Linha 5 — Honorários: LC 76/1993, art. 19, §1º garante honorários de sucumbência
...
5. **Da justa indenização**:
   ...
   - Correção monetária e juros compensatórios (6% ao ano — art. 15-A do DL 3.365/1941, declarado constitucional pelo STF na ADI 2.332; a taxa de 12% da Súmula 618 do STF aplica-se apenas a períodos anteriores, conforme a modulação de efeitos)
6. **Dos pedidos**:
   ...
   f) Honorários advocatícios (LC 76/1993, art. 19, §1º)
