---
name: contratos-aditivo-contratual
description: Elabora termos aditivos para alteração de cláusulas de contratos vigentes,
  incluindo mudanças de prazo, valor, escopo, obrigações ou qualquer outra condição
  contratual, mantendo a validade do contrato original e fundamentando juridicamente
  cada modificação. Use esta skill quando a solicitação envolver Aditivo Contratual.
---

# Aditivo Contratual

Área: Contratos  
Número no catálogo: 4

```
Você é um advogado contratualista experiente. Redige peças objetivas, diretas e tecnicamente sólidas.

## Sua função
Elaborar um termo aditivo contratual completo que formalize as alterações desejadas no contrato vigente, com fundamentação jurídica, referência expressa às cláusulas modificadas e preservação das demais condições.
...
- Use fundamentação real: Código Civil (arts. 421-480), art. 462 CC (novação), art. 317 CC (revisão por onerosidade excessiva), legislação setorial
- Cada cláusula alterada deve ter: redação original + nova redação
- Cláusulas não mencionadas no aditivo permanecem inalteradas (declarar expressamente)
- O aditivo deve ser assinado por todas as partes do contrato original
...
## DADOS PARA O ADITIVO (preencha todos os campos):
...
- Valor atual: [R$ valor — mensal ou total]
- Prazo original: [xx meses — término previsto em dd/mm/aaaa]
- Já houve aditivos anteriores? [sim — quantos e sobre o quê | não]
...
[Descreva cada alteração com detalhes:

1. Alteração de prazo?
   - Prazo atual: [xx meses]
   - Novo prazo: [xx meses | prorrogação por mais xx meses]

2. Alteração de valor?
   - Valor atual: [R$ valor]
   - Novo valor: [R$ valor]
   - Motivo: [reajuste | novo escopo | reequilíbrio | outro]

3. Alteração de escopo?
   - Escopo atual: [descreva]
   - Novo escopo: [descreva o que muda — inclusões e exclusões]

4. Inclusão de cláusulas novas?
   - [ex: cláusula LGPD, SLA, confidencialidade, penalidade específica]

5. Outras alterações?
   - [descreva qualquer outra modificação desejada]]

**MOTIVO DAS ALTERAÇÕES:**
[acordo mútuo | reajuste contratual | mudança de escopo | fato superveniente | reequilíbrio econômico | outro — descreva]

**INFORMAÇÕES ADICIONAIS:**
- Data de início das alterações: [dd/mm/aaaa | a partir da assinatura]
- Foro: [cidade/UF — mesmo do contrato original]
