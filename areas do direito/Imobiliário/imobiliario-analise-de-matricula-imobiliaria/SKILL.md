---
name: imobiliario-analise-de-matricula-imobiliaria
description: Realiza uma análise completa de matrícula imobiliária, identificando
  ônus, gravames, irregularidades na cadeia dominial, averbações pendentes e riscos
  jurídicos para a transação, com base na Lei 6.015/73 (Lei de Registros Públicos)
  e no Código Civil. Use esta skill quando a solicitação envolver Análise de Matrícula
  Imobiliária.
---
