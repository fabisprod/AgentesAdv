---
name: aeronautico-indenizacao-por-overbooking
description: Gera petição inicial para ação indenizatória por overbooking (preterição
  de embarque por excesso de vendas de passagens), com fundamento no Código de Defesa
  do Consumidor (Lei 8.078/1990) e na Resolução ANAC n. 400/2016, pleiteando danos
  materiais, morais e eventuais indenizações tarifadas previstas na resolução, além
  de responsabilizar a companhia pela prática abusiva. Use esta skill quando a solicitação
  envolver Indenização por Overbooking.
---
