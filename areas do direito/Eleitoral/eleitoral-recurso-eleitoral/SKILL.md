---
name: eleitoral-recurso-eleitoral
description: Gera recurso eleitoral (Recurso Inominado, Recurso Ordinário ou Recurso
  Especial Eleitoral) contra decisões da Justiça Eleitoral de primeiro grau ou dos
  TREs, com fundamentação técnica no Código Eleitoral, nas leis eleitorais e na jurisprudência
  do TSE. Use esta skill quando a solicitação envolver Recurso Eleitoral.
---
...
## Disclaimer
Ferramenta de auxílio. O advogado eleitoralista revisa antes de protocolar. Prazos eleitorais são improrrogáveis.
