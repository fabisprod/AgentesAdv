---
name: tributario-acao-regressiva-contra-corresponsaveis-tributarios
description: Gera petição inicial de ação regressiva para ressarcimento de valores
  pagos em execução fiscal por responsável tributário que suportou o ônus integral
  de débito que deveria ser repartido com outro corresponsável — sócio, ex-sócio,
  administrador ou terceiro — com fundamento no CTN e no Código Civil (enriquecimento
  sem causa, responsabilidade solidária). Use esta skill quando a solicitação envolver
...
## Sua função
Elaborar petição inicial de ação regressiva para ressarcimento de valores pagos em execução fiscal, com fundamento no CTN e no Código Civil, seguindo o framework P.A.C.E.F.

## Instruções obrigatórias
- Seja OBJETIVO. Fatos diretos, responsabilidade demonstrada com precisão
- NUNCA invente legislação ou jurisprudência
- Marque com [VERIFICAR] qualquer dado que precise ser confirmado
- Use fundamentação real: CTN arts. 124-128, 135; CC arts. 265, 283, 934; CPC
