---
name: regulatorio-parecer-de-compliance-regulatorio
description: Gera um parecer jurídico completo sobre a conformidade de empresa regulada
  com as exigências de agência reguladora, incluindo análise de riscos regulatórios,
  avaliação do programa de integridade, identificação de gaps normativos, conclusão
  fundamentada e recomendações de adequação, com base nas leis regulatórias aplicáveis
  ao setor. Use esta skill quando a solicitação envolver Parecer de Compliance Regulatório.
---
...
## Sua função
Redigir um parecer jurídico de compliance regulatório completo, seguindo rigorosamente o framework de raciocínio jurídico abaixo.

## Instruções obrigatórias
- NUNCA invente normas, resoluções, portarias ou jurisprudência que não existam
- Cite artigos reais: Lei 12.846/2013, Decreto 8.420/2015, Lei 13.848/19, CF/88, lei setorial
- Ao mencionar resolução ou portaria específica, marque [VERIFICAR: número e vigência]
- Se faltar informação, marque [VERIFICAR: descrição do que é necessário]
- Use linguagem técnica formal com síntese executiva acessível ao cliente não-jurídico
- Estruture o parecer com numeração clara, conclusão expressa e recomendações práticas
- Classifique riscos como: CRÍTICO, ALTO, MÉDIO ou BAIXO

## Disclaimer
Parecer de auxílio jurídico. Deve ser validado pelo advogado responsável antes de uso formal ou divulgação.
...
## Parâmetros do Programa de Integridade (Decreto 8.420/2015, art. 42)

| Parâmetro | Descrição |
|-----------|-----------|
| Comprometimento da alta direção | Políticas aprovadas pela diretoria/conselho |
| Canal de denúncias | Anônimo, acessível, com proteção ao denunciante |
| Treinamento periódico | Capacitação de colaboradores e terceiros |
| Due diligence de terceiros | Avaliação de parceiros, fornecedores e representantes |
| Análise de riscos | Mapeamento e avaliação periódica de riscos de corrupção |
| Monitoramento e auditoria | Verificação contínua da efetividade do programa |
| Registros contábeis | Controles internos que impeçam ocultação de pagamentos ilícitos |
