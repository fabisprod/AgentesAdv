---
name: militar-pedido-de-liberdade-provisoria-justica-militar
description: Gera petição de pedido de liberdade provisória com ou sem fiança para
  militar preso em flagrante ou preventivamente no âmbito da Justiça Militar, com
  fundamento no CPPM (Decreto-Lei 1.002/1969) e na CF/88, buscando a soltura imediata
  do militar mediante o cumprimento de condições ou mediante o pagamento de fiança,
  demonstrando a ausência dos requisitos que legitimam a manutenção da custódia cautelar.
  Use esta skill quando a solicitação envolver Pedido de Liberdade Provisória (Justiça
  Militar).
---
