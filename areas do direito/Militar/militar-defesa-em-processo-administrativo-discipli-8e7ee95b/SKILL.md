---
name: militar-defesa-em-processo-administrativo-discipli-8e7ee95b
description: Gera defesa escrita em Processo Administrativo Disciplinar (PAD) instaurado
  contra agente da Guarda Municipal, com fundamento na CF/88, na Lei 13.022/14 (Estatuto
  Geral das Guardas Municipais), na Lei 9.784/99 (processo administrativo federal
  subsidiário) e na legislação municipal específica, buscando a absolvição do guarda
  ou a aplicação da pena mais branda, com impugnação dos vícios processuais e dos
  fatos imputados. Use esta skill quando a solicitação envolver Defesa em Processo
  Administrativo Disciplinar - Guarda Municipal.
---
