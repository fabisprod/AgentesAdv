---
name: militar-recurso-em-sentido-estrito-cppm
description: Gera razões de recurso em sentido estrito (RESE) no âmbito da Justiça
  Militar, com fundamento nos arts. 516-537 do CPPM (Decreto-Lei 1.002/1969), para
  impugnar decisões interlocutórias mistas (que extinguem o processo sem julgamento
  do mérito), rejeição de denúncia, pronúncia, impronúncia, decretação ou revogação
  de prisão preventiva e outras hipóteses expressamente previstas no CPPM. Use esta
  skill quando a solicitação envolver Recurso em Sentido Estrito (CPPM).
---
