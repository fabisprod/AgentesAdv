---
name: civel-execucao-de-titulo-extrajudicial
description: >-
  Gera petição inicial de execução de título extrajudicial (cheque, nota promissória, contrato,
  CDA, escritura etc.), com demonstração dos requisitos do art. 783 do CPC/2015, requerimentos de
  penhora e demais medidas executivas. Use esta skill quando a solicitação envolver Execução de
  Título Extrajudicial. Contextos: - Para cobrar cheques, notas promissórias, duplicatas e outros
  títulos de crédito protestados - Para executar contratos com força executiva (art. 784 CPC) -
  Para execução de confissão de dívida, escritura pública ou instrumento particular assinado por 2
  testemunhas - Quando há título líquido, certo e exigível e o devedor não pagou
---
