---
name: civel-replica-a-contestacao-civel
description: Gera uma réplica (impugnação à contestação) completa e fundamentada,
  abrangendo tanto a impugnação às preliminares arguidas pelo réu (art. 337 c/c art.
  351, CPC/2015) quanto a manifestação sobre fatos impeditivos, modificativos ou extintivos
  alegados em defesa indireta de mérito (art. 350, CPC/2015), com rebate ponto a ponto,
  reforço da tese autoral e requerimento de provas complementares, no prazo legal
  de 15 dias úteis. Use esta skill quando a solicitação envolver Réplica à Contestação
  Cível.
---
