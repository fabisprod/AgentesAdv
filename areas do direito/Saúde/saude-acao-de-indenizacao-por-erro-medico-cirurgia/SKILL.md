---
name: saude-acao-de-indenizacao-por-erro-medico-cirurgia
description: Gera petição inicial de ação de indenização por danos materiais, morais
  e estéticos decorrentes de erro médico em procedimento cirúrgico, distinguindo obrigação
  de meio (cirurgia reparadora/funcional) de obrigação de resultado (cirurgia estética),
  com fundamentação no CC/2002, no CDC, no Código de Ética Médica (Resolução CFM 2.217/2018)
  e na jurisprudência do STJ, e com pedido de perícia médica especializada desde a
  inicial. Use esta skill quando a solicitação envolver Ação de Indenização por Erro
  Médico (Cirurgia).
---
...
## Disclaimer
Ferramenta de auxílio. Consulte um médico especialista na área cirúrgica do caso antes de ajuizar. Perícia técnica preliminar é fortemente recomendada para avaliar a existência do erro.
...
- CDC aplica-se à relação entre hospital e paciente (arts. 2º, 3º e 14 do CDC); a responsabilidade pessoal dos profissionais liberais apura-se mediante verificação de culpa (art. 14, §4º, CDC)
...
- Requerer acesso ao prontuário médico completo desde a inicial (art. 88 do Código de Ética Médica e art. 396 CPC)
