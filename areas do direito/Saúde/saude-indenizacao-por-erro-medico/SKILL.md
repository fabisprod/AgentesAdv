---
name: saude-indenizacao-por-erro-medico
description: Gera petição inicial de ação de indenização por danos materiais e morais
  decorrentes de erro médico (imperícia, imprudência, negligência), com fundamentação
  no CC/2002, no CDC, no CFM, na CF/88 e na jurisprudência do STJ sobre responsabilidade
  civil de profissionais de saúde, distinguindo obrigação de meio (médico) de obrigação
  de resultado (cirurgia estética, implantes). Use esta skill quando a solicitação
  envolver Indenização por Erro Médico.
---
...
- Prontuário médico: art. 88 do Código de Ética Médica (é vedado ao médico negar ao paciente acesso a seu prontuário) — direito do paciente ao acesso
...
- Correção monetária pelo IPCA (art. 389, parágrafo único, CC, com redação da Lei 14.905/2024) e juros de mora pela taxa legal (art. 406 CC)
- Danos morais: calcule com base na extensão do dano, capacidade econômica do réu e caráter pedagógico

## Disclaimer
Ferramenta de auxílio. O advogado revisa com especialista médico antes de protocolar. Laudo técnico preliminar é fortemente recomendado.
...
- A relação é consumerista? (o CDC aplica-se aos serviços médicos e hospitalares — arts. 2º, 3º e 14 do CDC; a responsabilidade pessoal do profissional liberal apura-se mediante culpa — art. 14, §4º, CDC)
...
- CPC/2015: arts. 369 (direito à prova / meios de prova), 464 a 480 (perícia), 373 (ônus da prova)
