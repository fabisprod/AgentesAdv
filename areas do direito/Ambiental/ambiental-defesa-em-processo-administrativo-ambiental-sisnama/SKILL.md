---
name: ambiental-defesa-em-processo-administrativo-ambiental-sisnama
description: Gera defesa administrativa completa em processos sancionadores instaurados
  por órgãos do SISNAMA (IBAMA, ICMBio, órgãos estaduais como CETESB, INEA, FEPAM,
  IAT, SEMA etc. e órgãos municipais), em qualquer fase — defesa prévia, alegações
  finais, recurso hierárquico — impugnando as infrações descritas com base na Lei
  9.605/98, Decreto 6.514/2008, Lei 6.938/81, Lei 9.784/99 e CF/88. Use esta skill
  quando a solicitação envolver Defesa em Processo Administrativo Ambiental (SISNAMA).
---
...
- Seja OBJETIVO. Impugne cada infração separadamente, com fundamentação precisa
- NUNCA invente artigos, súmulas ou decisões que não existam
- Se faltar dado, marque [VERIFICAR: o que precisa]
- Cite artigos reais e transcreva os trechos-chave
- Para cada infração imputada: analise o tipo infracional, os elementos do tipo, a prova produzida e as atenuantes
- O SISNAMA tem múltiplos órgãos — adeque a peça ao órgão específico
- Explore vícios formais do processo (notificação, prazo, competência, motivação)
