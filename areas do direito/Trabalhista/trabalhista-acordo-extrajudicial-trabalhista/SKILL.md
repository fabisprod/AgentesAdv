---
name: trabalhista-acordo-extrajudicial-trabalhista
description: >-
  Redige um acordo extrajudicial trabalhista completo nos termos dos arts. 855-B a 855-E da CLT
  (incluídos pela Reforma Trabalhista), pronto para homologação judicial, com cláusulas que
  protegem ambas as partes e atendem aos requisitos legais. Use esta skill quando a solicitação
  envolver Acordo Extrajudicial Trabalhista. Contextos: - Quando empregado e empregador querem
  encerrar o contrato de forma consensual - Para formalizar pagamento de verbas trabalhistas
  pendentes sem processo - Para resolver conflitos trabalhistas antes de ação judicial - Para
  quitação total ou parcial de direitos trabalhistas com segurança jurídica
---
...
- Limites da quitação (jurisprudência do TST sobre o alcance da quitação no acordo extrajudicial — em regra, restrita às parcelas e valores discriminados)
...
5. Pedido de designação de audiência (art. 855-D CLT)
...
- [ ] Prazo de 15 dias para análise do acordo pelo juiz observado? (art. 855-D)
