---
name: trabalhista-peticao-inicial-trabalhista
description: >-
  Gera uma reclamatória trabalhista completa no padrão real do PJe, com endereçamento,
  qualificação completa das partes, preliminares quando cabíveis, fatos objetivos, fundamentação
  com jurisprudência, pedidos com valores individualizados e requerimentos finais. Use esta skill
  quando a solicitação envolver Petição Inicial Trabalhista. Contextos: - Ao ajuizar reclamatória
  trabalhista - Para montar a peça inicial com estrutura profissional - Para garantir que não está
  esquecendo pedidos ou fundamentação - Como base que você revisa e personaliza ao caso
---
...
- Correção monetária pelo IPCA-E, acrescido dos juros legais (art. 39, caput, da Lei 8.177/91), na fase pré-judicial, e taxa SELIC a partir do ajuizamento, nos termos da ADC 58/STF, observadas as alterações da Lei 14.905/2024 a partir de 30/08/2024
