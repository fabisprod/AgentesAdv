---
name: previdenciario-apelacao-em-materia-previdenciaria
description: Gera o recurso de apelação em ações previdenciárias contra sentença desfavorável
  ao segurado, com fundamento nos arts. 1.009 a 1.014 do CPC, impugnando o mérito
  da decisão, erros de direito, erros de fato ou de valoração das provas, e requerendo
  a reforma da sentença pelo Tribunal Regional Federal. Use esta skill quando a solicitação
  envolver Apelação em Matéria Previdenciária.
---
