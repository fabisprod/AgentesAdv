---
name: previdenciario-agravo-de-instrumento-em-materia-previdenciaria
description: Gera o recurso de agravo de instrumento em matéria previdenciária para
  impugnar decisões interlocutórias do juiz de primeiro grau, especialmente indeferimento
  de tutela de urgência, indeferimento de produção de prova pericial, ou outras decisões
  que causem gravame imediato ao segurado, com fundamento no art. 1.015 do CPC. Use
  esta skill quando a solicitação envolver Agravo de Instrumento em Matéria Previdenciária.
---
