---
name: bancario-defesa-em-execucao-com-alienacao-fiduciaria
description: Gera embargos à execução ou impugnação ao cumprimento de sentença em
  processos executivos bancários com garantia de alienação fiduciária, explorando
  excesso de execução, nulidades, abusividades contratuais e o direito à purga da
  mora antes da consolidação da propriedade. Use esta skill quando a solicitação envolver
